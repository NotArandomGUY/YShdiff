...
const { mkdir: makeDirectory, stat, readFile: read, rm: remove, writeFile: write, unlink } = fs.promises
...
export async function rm(path: string, opts?: fs.RmOptions): Promise<void> {
